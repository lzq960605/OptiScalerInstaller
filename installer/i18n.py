...
_STRINGS_BY_LANG: dict[Lang, AppStrings] = {
    "ko": AppStrings(
        ...
        dialogs=DialogStrings(
            ...
            precheck_retry_mods_body="ReShade, Special K 등 다른 MOD 사용 중이면 확인 후 다시 설치해 주세요.",
    ...
    "en": AppStrings(
        ...
        main=MainUiStrings(
            ...
            install_section_title="3. Install Information",
        ...
        dialogs=DialogStrings(
            ...
            game_db_error_body="Failed to connect to Google Sheet.\nPlease check network or sheet permissions.",
